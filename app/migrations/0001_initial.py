# Generated by Django 3.1.7 on 2021-04-07 03:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('date_modified', models.DateTimeField(auto_now=True)),
                ('order_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='orders', to='app.orderuser')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', easy_thumbnails.fields.ThumbnailerImageField(upload_to='')),
